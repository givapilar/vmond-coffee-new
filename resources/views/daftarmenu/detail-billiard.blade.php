...
<section class="p-3">
    <div class="flex items-center justify-between">
        <div class="">
            <span class="text-lg font-bold dark:text-white ml-1">Detail Billiard</span>
        </div>
    </div>
    {{-- <form action="{{ route('add-cart-billiard',$paket_menu->id) }}" method="get"> --}}
    <form action="{{ route('checkout-billiard',$paket_menu->id) }}" method="POST">
        @csrf
    ...
    <div class="max-w-full mt-2 h-64 bg-white border border-gray-200 rounded-[30px] shadow px-3 overflow-y-auto dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="grid grid-cols-2 gap-2">
            <div class="mt-3">
                ...
                <select id="billiard_id" name="billiard_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" onchange="disableHour()">
