    ...
    <div class="grid grid-cols-2">
        <div class="text-base sm:text-sm px-1 py-3">
            <div class="aspect-h-1 h-24 aspect-w-1 overflow-hidden rounded-lg bg-gray-100 group-hover:opacity-75">
                <img src="https://images.unsplash.com/photo-1631247072479-8a1d03a060e7?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" alt="." class="object-cover object-center h-full w-full">
            </div>
            <div class="px-1">
                <p aria-hidden="true" class="text-xs mt-1 font-semibold dark:text-gray-300">Meeting Room #1</p>
        ...
        <div class="text-base sm:text-sm px-1 py-3">
            ...
            <div class="px-1">
                <p aria-hidden="true" class="text-xs mt-1 font-semibold dark:text-gray-300">Meeting Room #2</p>
                <span class="block text-[10px] dark:text-red-500">Rp.100.000,00 / Jam</span>
        ...
        <div class="text-base sm:text-sm px-1 py-3">
            ...
            <div class="px-1">
                <p aria-hidden="true" class="text-xs mt-1 font-semibold dark:text-gray-300">Meeting Room #3</p>
                <span class="block text-[10px] dark:text-red-500">Rp.100.000,00 / Jam</span>
