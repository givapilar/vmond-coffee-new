            ...
            <div class="px-6 py-2 space-y-4 md:space-y-6 ">
                <form class="space-y-4 md:space-y-6" action="{{ route('register') }}" method="POST">
                    ...
                    <div>
                        ...
                        <input id="telephone" type="tel" value="" name="telephone" aria-label="Please enter your phone number" placeholder="08xx-xxxx-xxxx" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 @error('telephone') is-invalid @enderror">
                        @error('telephone')
                            <span class="text-xs text-red-700">
                                {{ $message }}
                            </span>
