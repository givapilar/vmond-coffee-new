...
<section class="bg-gray-50 dark:bg-gray-900 ">
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        ...
        <div class=" text-center">
            ...
            {{-- <span class="text-xs font-light leading-tight tracking-[0.1rem] text-center text-gray-900 dark:text-white">
                Welcome!, signup account
            </span> --}}
        </div>
            ...
            <div class="px-6 py-2 space-y-4 md:space-y-6 ">
                ...
                <form class="space-y-4 md:space-y-6" action="{{ route('register', ['jenis_meja' => Request::query('jenis_meja'), 'kode_meja' => Request::query('kode_meja')]) }}" method="POST">
                    ...
                    <div>
                        ...
                        <input id="telephone" type="tel" value="" name="telephone" value="{{ 'telephone' }}" aria-label="Please enter your phone number" placeholder="08xx-xxxx-xxxx" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 @error('telephone') is-invalid @enderror">
                        @error('telephone')
                            <span class="text-xs text-red-700">
                                {{ $message }}
                            </span>
                    ...
                    <div x-data="{ show: true }">
                        ...
                        <div class="relative">
                            <input placeholder="*******"  name="password_confirmation" id="password_confirmation" :type="show ? 'password' : 'text'" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 @error('password') is-invalid @enderror">
                            <div class="absolute inset-y-0 right-0 pr-3 flex items-center text-sm leading-5">
                    ...
                    {{-- <div class="flex items-center justify-between">
                        ...
                        <div class="">
                            <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                                <a href="{{ route('login') }}" class="font-medium text-blue-600 hover:underline dark:text-blue-500">Forgot password?</a>
                            </p>
                        </div>
                    </div> --}}
                    ...
                    <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                        already have an account? <a href="{{ route('login', ['jenis_meja' => Request::get('jenis_meja'), 'kode_meja' => Request::get('kode_meja')]) }}" class="font-medium text-blue-600 hover:underline dark:text-blue-500">Sign in</a>
                    </p>
                </form>
            </div>
        </div>
