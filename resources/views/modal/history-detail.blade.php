                ...
                <div class="" x-data="invoices()" x-init="generateInvoiceNumber(111111, 999999);" x-cloak>
                    ...
                    <div class="flex mb-8 justify-between">
                        <div class="w-2/4">
                            ...
                            <div class="mb-2 md:mb-1 md:flex items-center">
                                <a href="{{ route('cetak-pdf',Crypt::encryptString($item->id)) }}">
                        ...
                        <div class="w-2/4" style="text-align: -webkit-right;">
                            ...
                            <div class="mb-2 md:mb-1 md:flex items-center">
                                <label class="w-32 text-gray-800 dark:text-gray-400 block font-bold text-sm uppercase tracking-wide"><span class="inline-flex items-center rounded-md bg-green-300 px-2 py-1 text-xs font-medium text-green-700 ring-1 ring-inset ring-green-600/20">{{ $item->status }}</span></label>
                            </div>
                    ...
                    <div class="py-2 ml-auto mt-5 w-full w-2/4">
                        ...
                        <div class="flex justify-between mb-4">
                            ...
                            <div class="text-right w-40">
                                <div class="text-sm text-gray-600">{{ number_format($item->total_price * 11/100,2 )  }}</div>
                            </div>
                        </div>
                        ...
                        <div class="py-2 border-t border-b">
                            <div class="flex justify-between">
                                ...
                                <div class="text-right w-40">
                                    <div class="text-xl text-gray-600">{{ number_format($item->total_price,2 )  }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
