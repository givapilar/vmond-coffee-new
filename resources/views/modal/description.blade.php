...
<!-- Main modal -->
<div id="description-modal{{ $item->id }}" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full overflow-x-hidden overflow-y-auto md:inset-0 h-full max-h-full">
            ...
            <div class="p-6 space-y-6 h-full max-h-[77%] overflow-y-scroll">
                ...
                <div class="border-2 border-gray-500 border-dashed rounded-lg p-4">
                    ...
                    <p class="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                        Coffe is a misspelling of the word "coffee." Coffee is a popular beverage that is brewed from roasted coffee beans. It is enjoyed by people all over the world for its stimulating effects and rich flavor.
                    </p>
                </div>
            </div>
            <!-- Modal footer -->
