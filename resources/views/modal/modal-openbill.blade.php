            ...
            <ul class="divide-y divide-gray-200 dark:divide-gray-700 px-3">
                ...
                <li class="py-3 sm:py-2">
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white">
                            <input required type="radio" id="edisi-{{ $item->id }}" value="Edisi" name="tipe_pemesanan" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        </div>
                    </div>
                </li>
                <li class="py-3 sm:py-2" style="display:none;" id="edisi-pembayaran-{{ $item->id }}">
...
<script>
    ...
    const edcRadio = document.getElementById(`edisi-${itemId}`);
    const edisiPembayaranWrapper = document.getElementById(`edisi-pembayaran-${itemId}`);
