...
const createQrisFintech = async () => {
  try {
    const headers = {
      "Content-Type": "application/json",
      "X-AUTH-TOKEN": "eyJhbGciOiJIUzUxMiJ9.eyJqdGkiOiJiNDA1MTgzNC1mZWJhLTRlMGUtYTViZS01Mjc0MzBhNzRiYjQiLCJzdWIiOiJWTU85MzcxOTI5ODgiLCJleHAiOjE2OTM0OTY0MDIsImlhdCI6MTY5MzQ2NjQwMiwiaWRlbnRpZmllciI6ImNhS2xJZ1paN1lvOFExYSIsInVzZXJuYW1lIjoiVk1POTM3MTkyOTg4In0.RLt1Zj3esOz7GPXwAs-7k154VB3YMfOdeh_x9rnczkEg-ooEsGWnVMzFIcY-Z9z-zSfF9MC6zJw2ni10bkw38Q" // Replace with actual X-AUTH-TOKEN value
    };
